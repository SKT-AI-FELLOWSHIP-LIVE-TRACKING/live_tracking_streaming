        ...
        <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          ...
          <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <select class="cursor-pointer drop-shadow-md bg-sky-200 w-72 duration-300 hover:bg-sky-400 focus:bg-gray-300"
              id="cameras"
              ...
              <Link to={`/tracking/${username}/${room}/${deviceId}`}>
                <input class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mt-4" type="submit" name="submit" value="Join Room" />
              </Link>
